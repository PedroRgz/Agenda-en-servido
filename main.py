#-*- coding: utf-8 -*-
#render_template ayuda a dibujar la pagina html
#request se encarga de las solicitudes que se hagan en la pagina
...
#ahora se agrega logica del codigo en esta parte
